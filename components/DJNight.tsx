        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              incredible beats, and unforgettable vibes. Dance till dawn with the{' '}
              <span className="text-neon-pink font-bold">best DJs</span> in town!
            </p>
            ...
            >
              {[
                'Live performances by celebrity DJs',
